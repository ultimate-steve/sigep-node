 ...
 */
 ...
 const SolicitarPostagemReversa = require('../services/SolicitarPostagemReversa')
 ...
 class Services {
     ...
     async solicitarPostagemReversa(data){
         let userData = this.user.getUser()
         let params = {
             ...data
         }
 
         let result = await SolicitarPostagemReversa( params, userData.usuarioReverso, userData.senhaReverso )
